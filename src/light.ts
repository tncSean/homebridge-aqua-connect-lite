...
/**
 * Platform accessory for Light-type devices (Pool Light).
 * Handles HomeKit Lightbulb service with proper async state management.
 */
export class Light {
    ...
    /**
     * Handle HomeKit set requests for the Lightbulb On characteristic.
    ...
    /**
     * Handle HomeKit get requests for the Lightbulb On characteristic.
