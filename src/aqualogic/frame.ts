...
export const FrameType = {
    ...
    // Wired keypad / remote-display port emits and accepts this frame type.
    // Frame body is key[2 LE] | held[2 LE] — press = key,key; release = key,0.
    // This is the only key format the Hayward Pro Logic accepts from the
    // wired bus (USR-W610 port). Confirmed by capture on 2026-04-18.
    LOCAL_WIRED_KEY_EVENT: Buffer.from([0x00, 0x02]),
} as const;
